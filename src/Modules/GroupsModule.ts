...
class GroupCommand extends Command {
    ...
    async resetPerm(
        event: Event, @ResponseArg response: Response, @Argument(GroupArg) group: Group,
    ...
    async resetAllPerms(
        event: Event, @ResponseArg response: Response, @MessageArg msg: Message, @Argument(GroupArg) group: Group
    ): Promise<void> {
